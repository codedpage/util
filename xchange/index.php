...
<?php 
	...
	<tr height="500" valign="top">
		<td width="95%"><div style="width:100%; height:100%;"><textarea id="phpeditor" name="phpeditor" style="border:0px; width:100%; height:85%"><?php echo isset($_GET['temp']) ? '' : htmlentities(file_get_contents('draft.txt'))?></textarea>
		<input type="button" style="width:100%; height:5%; font-size:20px;" onclick="clean()" value="C L E A R" />
		<input type="button" style="width:100%; height:10%; font-size:30px;"  onclick="save()" value="S A V E" /></div>
		</td> 				
	</tr>
	<?php } ?>
</table>
